    ...
    <main class="grid">
      <section class="panel">
        ...
        <form id="settings-form" class="form">
          ...
          <input id="shopName" name="shopName" value="${escapeAttribute(state.settings.shopName)}" placeholder="Nome negozio" required />
          <label for="lowStockThreshold">Soglia scorte basse</label>
          <input id="lowStockThreshold" name="lowStockThreshold" type="number" step="1" min="0" value="${Number(state.settings.lowStockThreshold || 0)}" placeholder="Soglia scorte basse" />
      ...
      <section class="panel wide">
        <div class="panel-header"><h2>Ticket</h2><label class="sr-only" for="search">Cerca ticket</label><input id="search" value="${escapeAttribute(filter)}" placeholder="Cerca ticket..." /></div>
